...
export function DeleteCategoryButton({ categoryId, categoryName }: DeleteCategoryButtonProps) {
  ...
  const handleDelete = async () => {
    ...
    if (error) {
      ...
      alert('Failed to delete category. Posts may be using this category.')
      setIsDeleting(false)
      return
    }
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
          ...
          <p className="text-gray-600 mb-4">
            Are you sure you want to delete &quot;{categoryName}&quot;? Posts in this category will become uncategorized.
          </p>
